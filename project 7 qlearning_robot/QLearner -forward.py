...
class QLearner(object): 
    ...
    def query(self,s_prime,r): 			  		 			 	 	 		 		 	  		   	  			  	
        ...
        if (self.dyna> 0) &(self.Q[self.s,self.a] != q):
            ...
            #if(self.visited[self.s,self.a] == False):
            #    self.visitedList.append((self.s,self.a))
            #    self.visited[self.s,self.a] = True
            self.visitedList.append((self.s,self.a))
            ...
            #dyna_nN = [-1-(i%listcount) for i in range(self.dyna)]  
            dyna_nN = [i%listcount for i in range(self.dyna)]			
            #print dyna_nN
