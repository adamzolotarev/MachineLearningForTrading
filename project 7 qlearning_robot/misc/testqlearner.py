...
def printQ(Q): 			  		 			 	 	 		 		 	  		   	  			  	
    ...
    for row in range(0, 10): 			  		 			 	 	 		 		 	  		   	  			  	
        for col in range(0, 10): 	  		 			 	 	 		 		 	  		   	  			  	
                ...
                print "{:7.3f}".format(np.max(Q[row*10+col])), 
...
# each epoch involves one trip to the goal 			  		 			 	 	 		 		 	  		   	  			  	
    ...
    return np.median(scores), scores 			  		 			 	 	 		 		 	  		   	  			  	
...
def test_code(): 			  		 			 	 	 		 		 	  		   	  			  	
    ...
    #epochs = 500
    epochs = 500
    total_reward, total_reward2 = test(data, epochs, learner, verbose) 			  		 			 	 	 		 		 	  		   	  			  	
    print epochs, "median total_reward" , total_reward 			  		 			 	 	 		 		 	  		   	  			  	
    print 			  		 			 	 	 		 		 	  		   	  			  	
    non_dyna_score = total_reward 			  		 			 	 	 		 		 	  		   	  			  	
 	
    print 'no dyna'
    print total_reward2.flatten()
    #return 0
    ...
    total_reward, total_reward3 = test(data, epochs, learner, verbose) 			  		 			 	 	 		 		 	  		   	  			  	
    print epochs, "median total_reward" , total_reward 			  		 			 	 	 		 		 	  		   	  			  	
